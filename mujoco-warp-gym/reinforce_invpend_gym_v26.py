...
from mujoco_warp_env import MujocoWarpEnv
...
class InvertedPendulumEnv(MujocoWarpEnv, utils.EzPickle):
    metadata = {
        "render_modes": [
            "human",
            "rgb_array",
...
register(
    id="my_inverted_pendulum-v0",
    entry_point=f"{__name__}:InvertedPendulumEnv",
...
env = gym.make("my_inverted_pendulum-v0", render_mode="human")
