...
try:
    ...
    raise error.DependencyNotInstalled(
        'mujoco/warp/mujoco_warp not installed'
    ) from e
...
class MujocoWarpEnv(gym.Env):
    ...
    def _initialize_simulation(
        ...
        self.m = mjwarp.put_model(model)
        self.d = mjwarp.put_data(model, data)
        mjwarp.step(self.m, self.d)
        mjwarp.step(self.m, self.d) # double warmup
    ...
    def _step_mujoco_simulation(self, ctrl, n_frames):
        ...
        mjwarp.get_data_into(self.data, self.model, self.d)
